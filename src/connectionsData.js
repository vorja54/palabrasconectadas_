...
{id:"jason-157",categories:[{name:"PALABRAS CON PREFIJO TELE",words:["TELEFONO","TELEVISION","TELESCOPIO","TELEGRAMA"],color:"yellow"},{name:"SINONIMOS DE VALIENTE",words:["AUDAZ","INTREPIDO","BRAVO","HEROICO"],color:"green"},{name:"COSAS QUE SE PUEDEN PINTAR",words:["CUADRO","PARED","LIENZO","MURAL"],color:"blue"},{name:"PALABRAS CON PRIMERA Y ULTIMA IGUAL",words:["AROMA","ANCLA","ARENA","ANTENA"],color:"purple"}]},
