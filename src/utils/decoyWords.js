...
const DECOY_WORDS = [
  ...
  // --- AÑADIDOS jul 2026 ---
  'ABANICO', 'ABEDUL', 'ABROJO', 'ABSORCIÓN', 'ABUELO', 'ABUNDANCIA', 'ABUSO', 'ACADEMIA',
  'ACANTILADO', 'ACARICIAR', 'ACECHO', 'ACELERACIÓN', 'ACENTO', 'ACEPCIÓN', 'ACERA', 'ACERCAMIENTO',
  'ACERTIJO', 'ACIDEZ', 'ÁCIDO', 'ACOGIDA', 'ACÓLITO', 'ACONDICIONAMIENTO', 'ACOPIO', 'ACRÓBATA',
  'ACTITUD', 'ACTIVACIÓN', 'ACTIVIDAD', 'ACTUACIÓN', 'ACUARIO', 'ACUCHILLAR', 'ACUEDUCTO', 'ACUERDO',
  'ADAPTACIÓN', 'ADELANTE', 'ADELGAZAR', 'ADHERENCIA', 'ADICCIÓN', 'ADMINISTRACIÓN', 'ADMIRACIÓN', 'ADMISIÓN',
  'ADOLESCENCIA', 'ADOPCIÓN', 'ADQUISICIÓN', 'ADULACIÓN', 'ADULTERIO', 'ADVENEDIZO', 'AFECTO', 'AFINIDAD',
  'AFIRMACIÓN', 'AFLICCIÓN', 'AFRENTA', 'AGENDA', 'AGENTE', 'AGILIDAD', 'AGITACIÓN', 'AGONÍA',
  'AGRADECIMIENTO', 'AGRAVIO', 'AGRESIÓN', 'AGRICULTOR', 'AGRICULTURA', 'AGRIETAR', 'AGUDEZA', 'AGUJERO',
  'AGUJETA', 'AGUZAR', 'AHOGAR', 'AISLAMIENTO', 'AJENO', 'AJUSTE', 'ALABANZA', 'ALARMA',
  'ALBA', 'ALBACEA', 'ALBAÑIL', 'ALBEDRÍO', 'ALBINO', 'ALBOROTO', 'ALBUM', 'ALCANCE',
  'ALCÁNDARA', 'ALCAZAR', 'ALCÁZAR', 'ALDEA', 'ALEGACIÓN', 'ALEGRÍA', 'ALEJAMIENTO', 'ALETA',
  'ALFABETO', 'ALGARABÍA', 'ALIANZA', 'ALICIENTE', 'ALIMENTACIÓN', 'ALIMENTO', 'ALIÑO', 'ALMIAR',
  'ALMIDÓN', 'ALQUILER', 'ALTERNATIVA', 'ALTILLO', 'ALUMBRADO', 'ALUMNO', 'ALZADA', 'AMAGAR',
  'AMANECER', 'AMANTE', 'AMARRE', 'AMATISTA', 'AMBICIÓN', 'AMBIGÜEDAD', 'ÁMBITO', 'AMBIENTE',
  'AMBOS', 'AMBULANCIA', 'AMENAZA', 'AMENIDAD', 'AMIGO', 'AMISTAD', 'AMNESIA', 'AMNISTÍA',
  'AMONESTACIÓN', 'AMORATADO', 'AMORTIGUAR', 'AMPLIACIÓN', 'AMPLITUD', 'AMPUTACIÓN', 'ANALFABETO', 'ANALISTA',
];
